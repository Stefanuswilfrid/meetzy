...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/meetzy__logo.png
  AssetGenImage get meetzyLogo =>
      const AssetGenImage('assets/images/meetzy__logo.png');
  ...
  /// List of all assets
  List<dynamic> get values =>
      [eoDummy, inviteBg, meetzyLogo, noUpcomingEvent, participantDummy];
}
